...
window.downloadExcel = function() {
  ...
  let rangeLabel = '';
  if (curDate==='7days') rangeLabel='Last_7_Days';
  else if (curDate==='month') rangeLabel='Last_Month';
  else {
...
async function applyFilters(){
  ...
  const showDownload = filtersApplied && (curDate==='7days' || curDate==='month' || curDate==='custom');
